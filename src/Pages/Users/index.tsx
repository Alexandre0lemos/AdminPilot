  ...
  return (
    <Container className="flex justify-center flex-1">
      <div className="flex flex-col w-[38rem] justify-center">
        <div className="flex flex-col justify-start mt-4 max-h-8/12 shadow-2xl overflow-scroll scrollbar-hide">
          <table className="min-w-full divide-y divide-gray-200 rounded-lg shadow-2xl overflow-hidden">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {usuarios.map((usuario: Usuario) => (
                ...
                >
                  <td className="px-6  whitespace-nowrap text-sm w-5/12 font-semibold text-center text-gray-700">
                    {usuario.id}
                  </td>
                  <td
        ...
        <button
          ...
          className="border border-white bg-gray-700 hover:bg-gray-600 p-1 hover:cursor-pointer text-white shadow-2xl uppercase rounded-bl-lg rounded-br-lg"
        >
          Cadastrar Usuario
        </button>
      </div>
